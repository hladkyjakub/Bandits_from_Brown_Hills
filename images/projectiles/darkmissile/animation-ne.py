...
def create_movement_animation(image_path, output_folder):
    ...
    with center point shifted 15 pixels down.
    ...
    for frame in range(TOTAL_FRAMES):
        ...
        if frame < MOVE_FRAMES:
            ...
            current_x = start_x + int(HEX_HORIZONTAL_SPACING * progress)
            current_y = start_y + int((-HEX_VERTICAL_SPACING//2) * progress)
            ...
            final_x = start_x + HEX_HORIZONTAL_SPACING
            final_y = start_y - HEX_VERTICAL_SPACING//2
...
if __name__ == "__main__":
    create_movement_animation("darkmissile-ne.png", "ne")
    create_gif("ne", "tile_movement_north-east.gif")
